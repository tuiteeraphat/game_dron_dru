  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-[500px] py-20 lg:py-0 flex flex-col items-center justify-center bg-gray-500 backdrop-blur-2xl  rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none">
          <img
